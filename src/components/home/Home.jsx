  ...
  return (
    ...
    <div > 
     ...
     <h1 className={styles["heading"]}>what we offeliy</h1>
      ...
      <button className={styles["left-btn"]} onclick="scrollLeft()">&#8592;</button>
     ...
     <div className={styles["scroll-container"]}>
      ...
      <button className={styles["right-btn"]} onclick="scrollRight()">&#8594;</button>
    ...
    <div className={styles["wrapper"]}>
     <h1>Meet Our Team</h1>
     <p>Our Team includes <br/>
      Developer AI &amp; Data Analaysis &amp; Web Develobment</p> 
